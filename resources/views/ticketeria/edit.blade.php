...
<h2 id="title-tickets">
    ...
    <form action="{{url('ticketeria/'.$ticket->id.'')}}" method="post">
        ...
        <div>
            <textarea class="desc-inp" name="descripcion" id="descripcion" class="descripcion" cols="25" rows="10" value="{{$ticket->subject}}">{{$ticket->subject}}</textarea>
        </div>
        <div>
            <button type="submit" class="enviar-btn">Editar</button>
        </div>
